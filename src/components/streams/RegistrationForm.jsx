																	...
																	const validateForm = () => {
																		...
																		if (
																			...
																			if (
																				...
																				errors['username'] =
																					'Please enter Alpha Character only';
																			}
																		}
																		if (!fields['emailid']) {
																			formIsValid = false;
																		...
																		if (
																			typeof fields['emailid'] !== 'undefined'
																		) {
																		...
																		if (
																			typeof fields['mobileno'] !== 'undefined'
																		) {
																			if (
																				!fields['mobileno'].match(/^[0-9]{10}$/)
																			) {
																				formIsValid = false;
																				errors['mobileno'] =
																		...
																		if (
																			...
																			if (
																				!strongRegex.test(fields['password'])
																			) {
																				formIsValid = false;
																				errors['password'] =
